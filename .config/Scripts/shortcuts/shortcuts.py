...
with open(".config/ranger/rc.conf.base") as rg:
    rang+=rg.read()
with open(".config/Scripts/shortcuts/aliases_sh.base") as ash:
    alsh+=ash.read()

rang+=("\n"+"#Aliases generated by shortcuts.py"+"\n"+"\n")
alsh+=("\n"+"#Aliases generated by shortcuts.py"+"\n"+"\n")


rang+=("# cd aliases{{{"+"\n")
alsh+=("# cd aliases{{{"+"\n")
with open(".config/Scripts/shortcuts/folders") as fold:
    for line in csv.reader(fold, dialect="excel-tab"):
        ...
        line[1] = line[1].replace("$USER", user)
...
with open(".config/Scripts/shortcuts/configs") as conf:
