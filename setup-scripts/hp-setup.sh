...
stow -S bash blueman compton git i3-base i3-hp light-locker mpd networkmanager polybar ranger rofi termite tmux touchegg twmn udiskie unclutter vim wall_looper Xinput-base Xinput-i3spacemod-hp Xorg zsh
